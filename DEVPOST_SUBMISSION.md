...
- [ ] Add the public repository URL: `https://github.com/joshhkimmm/mindpulse`
- [ ] Host the app or add the local judge instructions above to the private judge field.
- [ ] Upload a video of a demo of our app following rubric grading scale
- [ ] Submit through Devpost project submission and fill out fields
